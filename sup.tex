...
\begin{theorem}\label{spdsaushalf}
...
\end{theorem}
\begin{proof}
Follows from \Cref{asaus,psaus,spdsaus,spdsas} and the fact that $\ip{H^{-1}x,H^{-1}x}\leq \norm{H^{-1}}^2\norm{x}^2$.
\end{proof}
